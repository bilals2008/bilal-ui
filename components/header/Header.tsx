        ...
        >
          ...
          <div className="group relative inline-flex items-center gap-2 px-3 py-1 text-sm rounded-lg bg-zinc-900 dark:bg-zinc-100 transition-colors">
            ...
            <div className="relative z-10 flex items-center gap-2">
              <span className="text-white dark:text-zinc-900">BilalUi Pro</span>
              ...
              <div className="relative z-10 flex items-center justify-between w-full gap-2">
                ...
                <div className="flex items-center gap-6">
                  <Link href="/" className="flex items-center gap-2">
                    ...
                    {/* FIX: Removed "hidden sm:block" to make the name visible on all screen sizes */}
                    <span className="font-semibold">BilalUi</span>
                  </Link>
