      ...
      <div className="w-full flex flex-col items-center justify-center text-center gap-8">
        ...
        <div className="w-full max-w-5xl flex flex-col items-center text-center space-y-8">
          ...
          >
            ...
            <p className="mt-6 text-base md:text-xl text-zinc-700 dark:text-zinc-300 max-w-2xl mx-auto">
          ...
          >
            <span className="text-sm text-zinc-500 dark:text-zinc-300 pb-3 text-center flex items-center justify-center gap-2">
