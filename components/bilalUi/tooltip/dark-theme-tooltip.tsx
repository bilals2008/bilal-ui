  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <Button type="button" variant="ghost" size="icon" className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-slate-200 transition-colors duration-150 hover:bg-slate-300 dark:bg-slate-700 dark:hover:bg-slate-600">
