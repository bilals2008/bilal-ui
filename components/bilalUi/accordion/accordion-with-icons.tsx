      ...
      <AccordionItem value="free">
        <AccordionTrigger className="group">
          <div className="flex items-center gap-3">
            ...
            <span>Is Bilal UI free to use?</span>
          </div>
        </AccordionTrigger>
        <AccordionContent className="ms-12">
      ...
      <AccordionItem value="dependencies">
        <AccordionTrigger className="group">
          <div className="flex items-center gap-3">
            ...
            <span>Do I need to install any dependencies?</span>
          </div>
        </AccordionTrigger>
        <AccordionContent className="ms-12">
      ...
      <AccordionItem value="nextjs">
        <AccordionTrigger className="group">
          <div className="flex items-center gap-3">
            ...
            <span>Can I use this with Next.js?</span>
          </div>
        </AccordionTrigger>
        <AccordionContent className="ms-12">
      ...
      <AccordionItem value="customization">
        <AccordionTrigger className="group">
          <div className="flex items-center gap-3">
            ...
            <span>How do I customize the components?</span>
          </div>
        </AccordionTrigger>
        <AccordionContent className="ms-12">
