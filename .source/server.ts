...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "getting-started/meta.json": __fd_glob_1, }, {"components/button.mdx": __fd_glob_2, "getting-started/changelog.mdx": __fd_glob_3, "getting-started/installation.mdx": __fd_glob_4, "getting-started/introduction.mdx": __fd_glob_5, });