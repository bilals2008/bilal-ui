...
<Snippet defaultValue="bun">
  ...
  <SnippetTabsContent value="bun">bunx shadcn@latest add https://ui.bilal.dev/api/source/button01.json</SnippetTabsContent>
  <SnippetTabsContent value="npx">npx shadcn@latest add https://ui.bilal.dev/api/source/button01.json</SnippetTabsContent>
  <SnippetTabsContent value="pnpm">pnpm dlx shadcn@latest add https://ui.bilal.dev/api/source/button01.json</SnippetTabsContent>
</Snippet>
