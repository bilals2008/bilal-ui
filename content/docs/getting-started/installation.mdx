...
<Snippet defaultValue="bun">
  <SnippetHeader>
    ...
    <SnippetCopyButton value="bunx shadcn@latest add https://bilal-ui.vercel.app/api/source/button01.json" />
  </SnippetHeader>
  <SnippetTabsContent value="bun">
  <span className="text-pink-500">bunx </span>shadcn@latest add https://bilal-ui.vercel.app/api/source/button01.json
  </SnippetTabsContent>
  <SnippetTabsContent value="npx">
  <span className="text-pink-500">npx </span>shadcn@latest add https://bilal-ui.vercel.app/api/source/button01.json
  </SnippetTabsContent>
  <SnippetTabsContent value="pnpm">
  <span className="text-pink-500">pnpm dlx </span>shadcn@latest add https://bilal-ui.vercel.app/api/source/button01.json
  </SnippetTabsContent>
</Snippet>
<br />
<Callout type="tip">
