...
Bilal UI is a collection of open-source, copy-and-paste components built with React, Motion, Tailwind CSS. <Badge variant="pro" appearance="outline" className="ml-2 align-middle">Open Source</Badge>
